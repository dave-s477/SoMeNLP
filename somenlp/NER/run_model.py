...
def main(model_config, data_config, time, data_file_extension, label_file_extension, feature_file_extension, device, bef, aft, context_is_paragrapgh, save_dir='save'):  
    ...
    data_handler.load_input(bef, aft, context_is_paragrapgh)
